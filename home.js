...
const profilePic = document.getElementById("googleProfilePic");
...
// ===============================
// SESSION CHECK & PROFILE INFO
// ===============================
window.addEventListener("load", () => {
    const user = JSON.parse(localStorage.getItem("crunkUser"));
    if (!user) {
        // No user → stay on login page (if any login page logic)
        loader.style.display = "none";
        return;
    }

    // Set profile info
    profilePic.src = user.picture || "placeholder.png";
    popupProfilePic.src = user.picture || "placeholder.png";
    accountName.innerText = user.username || "User Name";
    accountEmail.innerText = user.email || "user@example.com";
...
menuTheme.addEventListener("click", () => {
    ...
    themeLabel.innerText = document.body.classList.contains("light-theme")
        ? "Light"
        : "Dark";
});
